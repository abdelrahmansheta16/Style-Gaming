...
import alienLogo from '../../public/assets/alien.svg'
import azukiLogo from '../../public/assets/azuki.svg'
import bitmartLogo from '../../public/assets/bitmart.svg'
    ...
    <main>
      ...
      <section className="flex justify-center items-center px-16 mt-32 max-md:px-5 max-md:mt-10 max-md:max-w-full">
        <div className="flex flex-col items-center max-w-full w-[1160px]">
          <h2 className="text-7xl font-bold tracking-tighter text-center bg-clip-text bg-[linear-gradient(96deg,#E2E2E2_-13.07%,#86868B_61.44%)] leading-[80px] text-zinc-900 max-md:max-w-full max-md:text-4xl">Text to <span className="font-bold text-gray-400">Gaming Creator</span></h2>
          ...
          <div className="flex flex-col justify-center self-stretch mt-8 bg-white rounded-3xl border border-solid border-stone-300 max-md:max-w-full">
            <div className="justify-center max-md:max-w-full">
              <div className="flex gap-0 max-md:flex-col max-md:gap-0">
                <div className="flex flex-col p-2 w-3/12 max-md:ml-0 max-md:w-full">
                  <div className="shrink-0 max-w-full h-[120px] w-[290px] bg-white border-none" />
                </div>
                <div className="flex flex-col ml-0 w-6/12 max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col grow justify-center items-center px-20 py-6 w-full font-semibold  border border-solid border-stone-300 bg-gray-100 leading-[110%] max-md:px-5 max-md:max-w-full">
                ...
                <div className="flex flex-col p-2 ml-0 w-3/12 max-md:ml-0 max-md:w-full">
                  <div className="shrink-0 max-w-full h-[120px] w-[290px] bg-white border-none" />
                </div>
              </div>
            </div>
            <div className="justify-center max-md:max-w-full">
              <div className="flex gap-0 max-md:flex-col max-md:gap-0">
                <div className="flex flex-col w-3/12 max-md:ml-0 max-md:w-full">
                  <div className="flex grow justify-center items-center px-16 py-9 w-full border border-solid border-stone-300 bg-gray-100 max-md:px-5 ">
                ...
                <div className="flex flex-col ml-0 w-3/12 max-md:ml-0 max-md:w-full">
                  <div className="flex grow justify-center items-center px-16 py-11 border border-solid border-stone-300 bg-white max-md:px-5">
                ...
                <div className="flex flex-col ml-0 w-3/12 max-md:ml-0 max-md:w-full">
                  <div className="flex grow justify-center items-center px-16 py-11 border border-solid border-stone-300 bg-gray-100 max-md:px-5 ">
                ...
                <div className="flex flex-col ml-0 w-3/12 max-md:ml-0 max-md:w-full">
                  <div className="flex grow justify-center items-center px-16 py-12 w-full border border-solid border-stone-300 bg-white max-md:px-5">
            ...
            <div className="justify-center max-md:max-w-full">
              <div className="flex gap-0 max-md:flex-col max-md:gap-0">
                <div className="flex flex-col w-3/12 max-md:ml-0 max-md:w-full">
                  <div className="flex grow justify-center items-center px-16 py-12 border border-solid border-stone-300 bg-white max-md:px-5">
                ...
                <div className="flex flex-col ml-0 w-3/12 max-md:ml-0 max-md:w-full">
                  <div className="flex grow justify-center items-center px-16 py-12 border border-solid border-stone-300 bg-gray-100 max-md:px-5">
                ...
                <div className="flex flex-col ml-0 w-3/12 max-md:ml-0 max-md:w-full">
                  <div className="flex grow justify-center items-center px-16 py-11 w-full border border-solid border-stone-300 bg-white max-md:px-5">
            ...
            <div className="justify-center max-md:max-w-full">
              <div className="flex gap-0 max-md:flex-col max-md:gap-0">
                ...
                <div className="flex flex-col ml-0 w-6/12 max-md:ml-0 max-md:w-full">
                  <div className="grow justify-center px-10 py-10 text-xl font-semibold leading-6 text-center border border-solid border-stone-300 bg-white text-neutral-400 max-md:px-5 max-md:max-w-full">
          ...
          <div className="flex flex-col justify-center self-stretch mt-8 bg-white rounded-3xl border border-solid border-stone-300 max-md:max-w-full">
            ...
            <div className="justify-center max-md:max-w-full">
              <div className="flex gap-0 max-md:flex-col max-md:gap-0">
                <div className="flex flex-col w-3/12 max-md:ml-0 max-md:w-full">
                  <div className="flex grow justify-center items-center px-16 py-12 border border-solid border-stone-300 bg-white max-md:px-5">
                    <img loading="lazy" src="https://s3-alpha-sig.figma.com/img/ef37/8981/bacd89fa1089edbd504ff8083aee7290?Expires=1719792000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=Sh6YVPKZKBCoNWQqU2ZwlsMpBJ8X~bn58EqXddm11S5TeeXpf~aEM-7j5c2Fl4WwqRei3C5EvDDZq-pjd9T1kJAprP0E5QEgdEqgkC4f0MHAyNukh4e-4N1aK6GtpeyGyS7Mwrry0nCwqUTenCncXJzLsgWTpqmocOBnwPWekRHGNAdV5HEgrfJqjgNWFx~iS5~0~~HqAd93n1TJDe9NlPdPO-BxniuAy1YygJTbPuJBvpWutdH9gKi1q49SHPgbkYE-ud10lHGs4jPrppbByVstL-9WsOWLIjLXDOm3mvb~nc9twDqvTBho-NVDaaAA~jmDS85wkMaG0cMwjF-DFQ" alt="Brand" className="aspect-[3.85] w-[156px]" />
                  </div>
                </div>
                <div className="flex flex-col ml-0 w-3/12 max-md:ml-0 max-md:w-full">
                  <div className="flex grow justify-center items-center px-16 py-12 border border-solid border-stone-300 bg-gray-100 max-md:px-5">
                    <Image loading="lazy" src={alienLogo} alt="Brand" className="w-40 aspect-[4]" />
                  </div>
                </div>
                <div className="flex flex-col ml-0 w-3/12 max-md:ml-0 max-md:w-full">
                  <div className="flex grow justify-center items-center px-16 py-11 w-full border border-solid border-stone-300 bg-white max-md:px-5">
                    <img loading="lazy" src="https://s3-alpha-sig.figma.com/img/abbd/5f1f/87c1aaaf952a84c0be9cc89a45a32133?Expires=1719792000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=IhF8uFXzyDST~faj4H799bh8amo0gDZhB-SLnA-5BoDBgFC3WDiNu23w~VcC2FNdgathZsMq-tDIYurLkjsDU300tAnPrl~yZ0G6xsIN~-9GkNizvV3UwRefWP17~u6Er6Uk8~~G9jWb0JMB0dxLZ3vpT9Zf1v13DQQkGQh2GQmwI4eTE72-qy9MnXOiJ23qfB2c7Hsul50BC4JawbhImAj4l3U9ubbc559D62MK35MXEdx4HemfErudYuCdzhPwguu-jdVNVmOuUz0Q5mVPmfYwfNN2o5x0elaTaqLxojTNekzT1dgeq-F39IyxlzVPexu0JREjrJmXx4xhiSq15A__" alt="Brand" className="w-[168px]" />
                  </div>
                </div>
                <div className="flex flex-col ml-0 w-3/12 max-md:ml-0 max-md:w-full">
                  <div className="flex grow justify-center items-center px-16 py-11 border border-solid border-stone-300 bg-gray-100 max-md:px-5">
                    <Image loading="lazy" src={azukiLogo} alt="Brand" className="mx-3.5 w-36 aspect-[4.55]" />
                  </div>
                </div>
              </div>
            </div>
            <div className="justify-center max-md:max-w-full">
              <div className="flex gap-0 max-md:flex-col max-md:gap-0">
                ...
                <div className="flex flex-col ml-0 w-6/12 max-md:ml-0 max-md:w-full">
                  <div className="grow justify-center px-10 py-10 text-xl font-semibold leading-6 text-center border border-solid border-stone-300 bg-white text-neutral-400 max-md:px-5 max-md:max-w-full">
                    STYLE Protocol is your platform for NFT
                    and 3D Asset usability. We make your
                    assets usable in gaming.
                  </div>
                </div>
                <div className="flex flex-col p-2 ml-0 w-3/12 max-md:ml-0 max-md:w-full">
                  <div className="shrink-0 max-w-full h-[120px] w-[290px] bg-white border-none" />
      ...
      <section className="flex justify-center items-center px-16 mt-32 max-md:px-5 max-md:mt-10 max-md:max-w-full">
        <div className="flex flex-col max-w-full w-[1160px]">
          <h2 className="self-center text-7xl font-bold tracking-tighter text-center bg-clip-text bg-[linear-gradient(96deg,#E2E2E2_-13.07%,#86868B_61.44%)] leading-[80px] text-zinc-900 max-md:max-w-full max-md:text-4xl">Stake <span className="text-gray-400">$STYLE</span></h2>
              ...
              <div className=" bg-white rounded-3xl border border-gray-200 flex flex-col md:flex-row">
                <div className="flex-1 border-b md:border-b-0 md:border-r border-gray-200 p-4 md:p-10">
                  <div className='flex flex-col justify-start items-start'>
                    <h2 className="text-2xl font-bold text-gray-300">TIER 1</h2>
                ...
                <div className="flex-1 rounded-b-3xl md:rounded-b-none md:rounded-r-3xl bg-gray-100 p-4 md:p-10">
                  <p className="text-lg md:text-2xl pt-4 text-gray-800">Get access to <span className='text-gray-400 font-thin'>nft-collections</span> with usability in games. Every nft-collection will be <span className='text-gray-400 font-thin'>usable for playing.</span></p>
                </div>
              </div>
            </div>
          </section>
          ...
          <div className="mt-6 max-md:max-w-full">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
              <article className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                <div className="flex flex-col grow justify-center rounded-[32px] max-md:mt-6 max-md:max-w-full">
                  <div className="w-full rounded-3xl">
                    <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/4baae9a6e4b40a2a785358dc0d21399fdbc9f3b36d003bce1d70a46af9d20b12?apiKey=e60c5ff185ab4b01891f0d142201f3de&" alt="Space Cowboys" className="w-full rounded-3xl aspect-[1.27] blur-[3px] max-md:max-w-full" />
                  </div>
                  <div className="justify-between p-6 max-md:px-5 max-md:max-w-full">
                    <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                      <div className="flex flex-col w-[67%] max-md:ml-0 max-md:w-full">
                        <div className="flex flex-col justify-start items-start grow font-semibold leading-[110%] max-md:mt-10">
                          ...
                          <div className="flex gap-2 justify-center mt-3 text-base uppercase text-zinc-900">
                            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/4c3e66b2c541751b3efabc4ee1123eaff6124fa6582c1c8bcbba082ecc58d548?apiKey=e60c5ff185ab4b01891f0d142201f3de&" alt="" className="mt-1 shrink-0 self-start w-4 aspect-square" />
                            <p>30 Min</p>
                          </div>
                        </div>
                      </div>
                      <div className="flex flex-col ml-5 w-[33%] max-md:ml-0 max-md:w-full">
                        <div className="flex gap-5 justify-between self-stretch my-auto text-base leading-4 uppercase max-md:mt-10">
                          ...
                          <div className="flex flex-col justify-center">
                            <p className="bg-clip-text bg-[linear-gradient(97deg,#000_-12.84%,#666_87.14%)]">Quantity</p>
              ...
              <article className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                <div className="flex flex-col grow justify-center rounded-[32px] max-md:mt-6 max-md:max-w-full">
                  <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/f11d1a480198334d15e43cda924bd7ca002fae4587e92aeebde258bca9d82e9c?apiKey=e60c5ff185ab4b01891f0d142201f3de&" alt="On Chain Orcs" className="w-full rounded-3xl aspect-[1.27] blur-[3px] max-md:max-w-full" />
                  <div className="justify-between p-6 max-md:px-5 max-md:max-w-full">
                    <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                      <div className="flex flex-col w-3/5 max-md:ml-0 max-md:w-full">
                        <div className="flex flex-col justify-start items-start grow font-semibold leading-[110%] max-md:mt-10">
                          <h3 className="text-3xl text-center text-neutral-400">On Chain Orcs</h3>
                          <div className="flex flex-row items-center gap-2 justify-center mt-3 text-base uppercase text-zinc-900">
                            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/94caefd9067e6bbdb20560587ce93d17d7d14088451ab5277ec39b823fb5a387?apiKey=e60c5ff185ab4b01891f0d142201f3de&" alt="" className="mt-1 shrink-0 self-start w-4 aspect-square" />
                            <p>3 DAYS</p>
                          </div>
                        </div>
                      </div>
...
function Footer() {
  return (
    <footer className="flex justify-center items-center px-16 shrink-0 pt-32 bg-black bg-opacity-0 max-md:mt-10 max-md:max-w-full">
      <div className="flex flex-col justify-center self-center p-20 max-w-full bg-white rounded-t-3xl w-[1360px] max-md:px-5 max-md:mt-10">
        ...
        <h3 className="mt-2 text-7xl font-semibold tracking-tighter text-start bg-clip-text bg-[linear-gradient(96deg,#E2E2E2_-13.07%,#86868B_61.44%)] leading-[88px] text-zinc-900 max-md:max-w-full max-md:text-4xl">
          <span>Unlock&nbsp;</span>
        ...
        <div className="flex gap-5 justify-between mt-10 w-full max-md:flex-wrap max-md:max-w-full">
          ...
          <div className="flex gap-0 justify-center max-md:flex-wrap">
            ...
            <div className="flex justify-center items-center px-9 py-10 border border-solid bg-black bg-opacity-0 border-stone-300 max-md:px-5">
              <Image loading="lazy" src={bitmartLogo} alt="Logo" className="w-50" />
            </div>
