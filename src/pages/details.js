...
function Header() { 
  return (
    <header className="flex justify-center items-center px-16 bg-white max-md:px-5">
      <div className="flex flex-col max-w-full w-[1440px]">
        <div className="flex flex-col justify-center items-center pb-6 font-semibold leading-[110%] max-md:max-w-full">
          <nav className="flex justify-center items-center self-stretch px-16 py-6 text-base tracking-wide text-black uppercase max-md:px-5 max-md:max-w-full">
            <div className="flex gap-5 justify-between max-w-full w-[1200px] max-md:flex-wrap">
              <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/d6889f9ef4ee93477cb2a71c829848190364bbf5445c12427844aa416938ca74?apiKey=e60c5ff185ab4b01891f0d142201f3de&" alt="Logo" className="shrink-0 self-start max-w-full aspect-[3.33] w-[134px]" />
              <div className="flex gap-4">
                <button className="justify-center px-6 py-3 border border-black border-solid bg-black bg-opacity-10 rounded-[300px] max-md:px-5">Log In</button>
                <button className="justify-center px-6 py-3 whitespace-nowrap border border-black border-solid rounded-[300px] max-md:px-5">Register</button>
              </div>
            </div>
          </nav>
          ...
          <h1 className="mt-4 text-7xl tracking-tighter text-center bg-clip-text bg-[linear-gradient(96deg,#E2E2E2_-13.07%,#86868B_61.44%)] leading-[80px] text-zinc-900 max-md:max-w-full max-md:text-4xl max-md:leading-10">
            <span className="font-bold">Transforming NFTs and</span><br /><span className="font-bold">3D assets into Gaming</span><br /><span className="font-bold">Assets with </span><span className="font-bold">$STYLE</span>
          </h1>
...
function MainContent() { 
  return (
    <main>
      <section className="flex flex-col justify-center items-start self-center mt-32 max-w-full bg-white w-[1160px] max-md:pr-5 max-md:mt-10">
        <article className="flex overflow-hidden relative flex-col pt-2.5 max-w-full min-h-[356px] stroke-[1px] stroke-black stroke-opacity-50 w-[606px]">
      ...
      <section className="flex flex-col items-center self-center mt-32 max-w-full bg-white w-[1160px] max-md:mt-10">
        ...
        <p className="mt-8 text-3xl font-medium leading-8 text-center text-neutral-400 max-md:max-w-full">Turn your favorite NFTs or 2D images into<br />functional gaming assets.</p>
        <div className="flex gap-5 justify-between mt-4 text-base leading-4 uppercase">
          <div className="flex gap-2 justify-center">
            <p className="bg-clip-text bg-[linear-gradient(97deg,#000_-12.84%,#666_87.14%)]">Access&nbsp;</p>
        ...
        <a href="#" className="flex gap-2 justify-center px-6 py-3 mt-6 text-base font-semibold tracking-wide leading-4 uppercase border border-black border-solid bg-black bg-opacity-10 rounded-[300px] text-zinc-900 max-md:px-5">
          <span>Try now</span>
          <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/3d93781bbb54034d7966adbe3dcfa47db6e9c39b1079f161603cfbdb63e81c6b?apiKey=e60c5ff185ab4b01891f0d142201f3de&" alt="" className="shrink-0 self-start w-4 aspect-square" />
        </a>
        ...
        <div className="flex flex-col justify-center self-stretch mt-8 bg-white rounded-3xl border border-solid border-stone-300 max-md:max-w-full">
          ...
          <div className="justify-center max-md:max-w-full">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
              <div className="flex flex-col w-3/12 max-md:ml-0 max-md:w-full">
                <div className="flex grow justify-center items-center px-16 py-10 border border-solid border-stone-300 max-md:px-5">
                  <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/3408fe5f20f1e14a6d88f8d4436ea587e568eb21895c176376a8cb1318ae71be?apiKey=e60c5ff185ab4b01891f0d142201f3de&" alt="Logo" className="mr-3 ml-3.5 aspect-[3.33] w-[145px]" />
                </div>
              </div>
              <div className="flex flex-col ml-5 w-3/12 max-md:ml-0 max-md:w-full">
                <div className="flex grow justify-center items-center px-16 py-12 w-full border border-solid bg-black bg-opacity-0 border-stone-300 max-md:px-5">
                  <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/f8987a8cf444124110fa4378a6af10617df6d08758952e1522f64410796024c5?apiKey=e60c5ff185ab4b01891f0d142201f3de&" alt="Logo" className="mr-3 ml-3.5 aspect-[5.26] w-[145px]" />
                </div>
              </div>
              <div className="flex flex-col ml-5 w-3/12 max-md:ml-0 max-md:w-full">
                <div className="flex grow justify-center items-center px-16 py-6 border border-solid border-stone-300 max-md:px-5">
                  <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/0c1f31700d1237e144950653f2fbd752e3bfe9ef84b271f7df7380cee286cca0?apiKey=e60c5ff185ab4b01891f0d142201f3de&" alt="Logo" className="mr-4 ml-4 aspect-[1.89] w-[139px]" />
                </div>
              </div>
              <div className="flex flex-col ml-5 w-3/12 max-md:ml-0 max-md:w-full">
                <div className="flex grow justify-center items-center px-16 py-11 w-full border border-solid bg-black bg-opacity-0 border-stone-300 max-md:px-5">
                  <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/4761b448a6cea7e9554744723def4dc566fc879e0a5fc9bad9a7265b5621c160?apiKey=e60c5ff185ab4b01891f0d142201f3de&" alt="Logo" className="aspect-[5.26] w-[165px]" />
                </div>
              </div>
            </div>
          </div>
          <div className="justify-center max-md:max-w-full">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
              ...
              <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
                <div className="grow justify-center px-10 py-7 text-xl font-semibold leading-6 text-center border border-solid border-stone-300 text-neutral-400 max-md:px-5 max-md:max-w-full">
                  STYLE Protocol is your platform for NFT<br />and 3D Asset usability. We make your<br />assets usable in gaming.
                </div>
              </div>
              <div className="flex flex-col ml-5 w-3/12 max-md:ml-0 max-md:w-full">
                <div className="shrink-0 mx-auto max-w-full border border-solid bg-black bg-opacity-0 border-stone-300 h-[120px] w-[290px]" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="flex justify-center items-center px-16 mt-32 max-md:px-5 max-md:mt-10 max-md:max-w-full">
        <div className="flex flex-col max-w-full w-[1160px]">
          ...
          <section className="mt-20 max-md:mt-10 max-md:max-w-full">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
              <ChoosePowerCard imgSrc="https://cdn.builder.io/api/v1/image/assets/TEMP/df7204159c3839c7f68489a40adde641322f695b01e2390409b60d9dc049f86a?apiKey=e60c5ff185ab4b01891f0d142201f3de&" title="1000 $STYLE" description="Get access to nft-collections with usability in games. Every nft-collection will be usable for playing." />
              <ChoosePowerCard imgSrc="https://cdn.builder.io/api/v1/image/assets/TEMP/18ed74bd1353427add0cf3ca6da5a2c4e16c669303c5d4503cf387faeccdfdce?apiKey=e60c5ff185ab4b01891f0d142201f3de&" title="Locked 1 month" description="Get access to nft-collections with usability in games. Every nft-collection will be usable for playing." />
            </div>
          </section>
...
function Footer() { 
  return (
    <footer className="shrink-0 mt-32 bg-black bg-opacity-0 h-[562px] max-md:mt-10 max-md:max-w-full">
